...
func (m *ExampleMsg) CloneVT() *ExampleMsg {
	...
	r.OtherMsg = protobuf_go_lite.CloneVTValue(m.OtherMsg)
...
func (this *ExampleMsg) EqualVT(that *ExampleMsg) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.OtherMsg, that.OtherMsg) {
		return false
	}
...
func (m *ExampleMsg) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ExampleField) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ExampleField)
		i--
		dAtA[i] = 0xa
	}
...
func (m *ExampleMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ExampleField)
	if m.OtherMsg != nil {
		l = m.OtherMsg.SizeVT()
...
func (x *ExampleMsg) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ExampleMsg")
	if x.ExampleField != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "example_field")
		protobuf_go_lite.TextWriteString(&sb, x.ExampleField)
	}
	if x.OtherMsg != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "other_msg")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.OtherMsg)
	}
...
func (m *ExampleMsg) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.OtherMsg.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
