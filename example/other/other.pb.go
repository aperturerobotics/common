...
func (m *OtherMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.FooField)
...
func (x *OtherMsg) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "OtherMsg")
	if x.FooField != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "foo_field")
		protobuf_go_lite.TextWriteUint(&sb, x.FooField)
	}
...
func (m *OtherMsg) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.FooField = 0
			m.FooField, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
