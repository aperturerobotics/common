...
require (
	...
	github.com/golangci/golangci-lint/v2 v2.14.0 // latest
	github.com/goreleaser/goreleaser/v2 v2.18.2 // latest
	github.com/psampaz/go-mod-outdated v0.9.0 // latest
	golang.org/x/tools v0.50.0 // latest
	mvdan.cc/gofumpt v0.12.0 // latest
)
...
require (
	...
	google.golang.org/grpc v1.83.2 // indirect; latest
