...
replace (
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20211102202547-e9cf271f7f2c
	google.golang.org/protobuf => github.com/paralin/protobuf-go v1.27.2-0.20220609075637-a1d116b0035f // aperture
)

require (
	github.com/aperturerobotics/starpc v0.8.6
